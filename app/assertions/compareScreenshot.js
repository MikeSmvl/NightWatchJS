...
exports.assertion = function(filename, expected) {
  ...
  this.expected = expected || 6; // misMatchPercentage tolerance default 0%
  ...
  this.pass = function(value) {
    ...
    if (pass) {
      ...
      this.message =
        ...
        '   Open ' +
        diffPath +
        ' to see how the screenshot has changed.\n' +
